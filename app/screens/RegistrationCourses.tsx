...
const RegistrationCourse = () => {
  ...
  }, [filteredMemberId, filterType]);

  useEffect(() => {
    if (isInitialized) {
      fetchCourses(currentPage, ITEMS_PER_PAGE, activeFilters);
    }
  }, [currentPage, activeFilters, isInitialized]);
  ...
  const renderErrorComponent = () => (
    <View style={styles.errorContainer}>
      ...
      <TouchableOpacity
        ...
        onPress={() => fetchCourses(currentPage, ITEMS_PER_PAGE, activeFilters)}
      >
      ...
      <View style={styles.container}>
        ...
        >
          {coursesError ? (
            ...
            <>
              <FlatList
                data={(coursesLoading || initialLoading) ? createSkeletonData() : courses}
