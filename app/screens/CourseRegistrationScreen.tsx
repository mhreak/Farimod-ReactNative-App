    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.errorContainer}>
          <MaterialIcons name="error-outline" size={80} color={modernColors.medium} />
          <AppText style={styles.errorTitle}>دوره یافت نشد</AppText>
          <AppText style={styles.errorSubtitle}>اطلاعات دوره موجود نیست</AppText>
          ...
          <View style={styles.courseCard}>
            <View style={styles.courseCardHeader}>
              <View style={styles.courseIconBadge}>
                <MaterialIcons name="menu-book" size={20} color={modernColors.info} />
              </View>
            ...
            <View style={styles.discountCard}>
              ...
              <View style={styles.discountInputRow}>
                <TouchableOpacity
                  style={[
                    styles.applyButton,
                    (isCheckingCode || !discountCode.trim()) && styles.applyButtonDisabled,
                  ]}
              ...
              {codeApplied && discountAmount > 0 && (
                <View style={styles.discountSuccessBanner}>
                  <AppText style={styles.discountSuccessText}>
                    ✓ {toPersianDigits(formatPrice(discountAmount))} تومان تخفیف اعمال شد
                  </AppText>
                </View>
              )}
            </View>
      ...
      <View style={styles.bottomButtonContainer}>
        <TouchableOpacity
          style={[
            ...
            (!courseData.RegisterActive || isRegistering) && styles.paymentButtonDisabled
          ]}
        ...
        >
          <LinearGradient
            colors={courseData.RegisterActive ? ['#2ecc71', '#27ae60'] : ['#95a5a6', '#7f8c8d']}
            start={{ x: 0, y: 0 }}
            end={{ x: 1, y: 0 }}
            ...
            {isRegistering ? (
              ...
              <>
                ...
                <AppText style={styles.paymentButtonText}>
                  {courseData.RegisterActive ? 'ثبت‌نام و پرداخت' : 'ثبت‌نام غیرفعال'}
                </AppText>
